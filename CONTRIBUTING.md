Contributing to ADSAI Core
============================

The ADSAI Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ADSAI Core project, and is not to be
confused with overall ADSAI Network Protocol consensus changes.

Whether a pull request is merged into ADSAI Core rests with the project merge
...
Patches that change ADSAI consensus rules are considerably more involved than
...
Where a patch set proposes to change the ADSAI consensus, it must have been
...
The project leader is the release manager for each ADSAI Core release.
