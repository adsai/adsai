...
RESOURCES += src/qt/adsai.qrc src/qt/adsai_locale.qrc

TRANSLATIONS += src/qt/locale/adsai_bg.ts \
                src/qt/locale/adsai_de.ts \
                src/qt/locale/adsai_en.ts \
                src/qt/locale/adsai_es.ts \
                src/qt/locale/adsai_fi.ts \
                src/qt/locale/adsai_fr.ts \
                src/qt/locale/adsai_it.ts \
                src/qt/locale/adsai_ja.ts \
                src/qt/locale/adsai_pl.ts \
                src/qt/locale/adsai_pt.ts \
                src/qt/locale/adsai_ru.ts \
                src/qt/locale/adsai_sk.ts \
                src/qt/locale/adsai_sv.ts \
                src/qt/locale/adsai_vi.ts \
                src/qt/locale/adsai_zh_CN.ts \
                src/qt/locale/adsai_zh_TW.ts
