...
This issue tracker is only for technical issues related to ADSAI Core.
General ADSAI questions and/or support requests and are best directed to the [ADSAI Slack](http://adsai.slack.com).
...
### What version of ADSAI Core are you using?
