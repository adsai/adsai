...
#   c) node1 mines 32 blocks, so now node 0 has 60001adai, node 1 has 4250adai, node2 has none.
#   d) node0 sends 601 adai to node2, in two transactions (301 adai, then 300 adai).
