...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Adsai Core adsai-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  adsai-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adsai transaction") + "\n" +
                               "  adsai-tx [options] -create [commands]   " + _("Create hex-encoded adsai transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded adsai transaction
