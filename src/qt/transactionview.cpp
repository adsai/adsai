                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Adai from zAdai"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAdai"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAdai));
