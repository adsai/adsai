                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ADSAI Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ADSAI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and adsai: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ADSAI Core"), this);
    aboutAction->setStatusTip(tr("Show information about ADSAI Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ADSAI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ADSAI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ADSAI addresses"));
    ...
    openAction->setStatusTip(tr("Open a ADSAI: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ADSAI Core help message to get a list with possible ADSAI command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ADSAI Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ADSAI network", "", count));
}
...
{
    QString strTitle = tr("ADSAI Core"); // default title
