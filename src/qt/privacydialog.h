...
public:
    ...
    void setZAdaiControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzADAI_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzADAI_clicked();
    void on_pushButtonZAdaiControl_clicked();
