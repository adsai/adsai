...
/** Utility functions used by the ADSAI Qt UI.
 */
namespace GUIUtil
{
...
// Render ADSAI addresses in monospace font
...
// Parse "adsai:" URI into recipient object, return true on successful parsing
