...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Adsai features */
        {"adsai", "masternode", &masternode, true, true, false},
        {"adsai", "listmasternodes", &listmasternodes, true, true, false},
        {"adsai", "getmasternodecount", &getmasternodecount, true, true, false},
        {"adsai", "masternodeconnect", &masternodeconnect, true, true, false},
        {"adsai", "masternodecurrent", &masternodecurrent, true, true, false},
        {"adsai", "masternodedebug", &masternodedebug, true, true, false},
        {"adsai", "startmasternode", &startmasternode, true, true, false},
        {"adsai", "createmasternodekey", &createmasternodekey, true, true, false},
        {"adsai", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"adsai", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"adsai", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"adsai", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"adsai", "getmasternodescores", &getmasternodescores, true, true, false},
        {"adsai", "mnbudget", &mnbudget, true, true, false},
        {"adsai", "preparebudget", &preparebudget, true, true, false},
        {"adsai", "submitbudget", &submitbudget, true, true, false},
        {"adsai", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"adsai", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"adsai", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"adsai", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"adsai", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"adsai", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"adsai", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"adsai", "checkbudgets", &checkbudgets, true, true, false},
        {"adsai", "mnsync", &mnsync, true, true, false},
        {"adsai", "spork", &spork, true, true, false},
        {"adsai", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"adsai", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use adsaid, or the -server option to adsai-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> adsai-cli " + methodname + " " + args + "\n";
}
