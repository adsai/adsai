...
In order to support loading of multiple wallets in adsai-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adsai.cpp.
...
Changes to adsai.cpp
----------------------
adsai.cpp is the entry point into adsai-qt, and as such, will require some minor modifications to provide hooks for
